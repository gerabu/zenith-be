...
Cryptographic validation of Google-issued bearer tokens on incoming requests, exposure of the authenticated principal to handlers, and synchronization (upsert) of authenticated users into the system database.
